(function () {
  ...
  var active = document.querySelector('.event-detail-page');
  var isStandalonePage = Boolean(active);

  for (var i = 0; !active && i < details.length; i += 1) {
  ...
  // Standalone pages already render their metadata and schema through Jekyll.
  if (!isStandalonePage) {
